const div = `<div style="display:inline-block; width:20px; height:20px;
              ...
              border 2px solid black; border-radius:2px; background-color:white;">`;
