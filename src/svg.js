function iconDiv(name, blkId, style) {
  const styleStr = style ? `style="${style}"` : '';
  return `<div id="${blkId}-icon-${name}" class="hover button" ${styleStr}>`
};

function iconHtml(name, blkId, style) {
  switch(name) {
    case 'close-border': return iconDiv(name, blkId, style) + `
    ...
    case 'close': return iconDiv(name, blkId, style) + `
    ...
    case 'collapse': return iconDiv(name, blkId, style) + `
    ...
    case 'expand': return iconDiv(name, blkId, style) + `
 ...
 case 'up-ptr': return iconDiv(name, blkId, style) + `
 ...
 case 'down-ptr': return iconDiv(name, blkId, style) + `
 ...
 case 'home': return iconDiv(name, blkId, style) + `
